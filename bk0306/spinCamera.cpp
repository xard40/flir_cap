...
{
    pSystemPtr = System::GetInstance();
    mCameraList = pSystemPtr->GetCameras();
}
...
{
    mCameraList.Clear();
    pSystemPtr->ReleaseInstance();
}

/********************************************************************
*
*********************************************************************/
cCamManager& cCamManager::the_manager()
{
    static cCamManager m;
    return m;
}
...
*
*********************************************************************/
CameraPtr cCamManager::get_camera(const std::string& serial_number) const
{
...
*
*********************************************************************/
CameraPtr cCamManager::get_camera(int index) const
{
    std::cout << mCameraList.GetSize()<< std::endl;
...
{
    pCameraPtr = cCamManager::the_manager().get_camera(serialNumber);
    pCameraPtr->Init();
...
{
    pCameraPtr = cCamManager::the_manager().get_camera( index );
    pCameraPtr->Init();
    pNodeMap = &pCameraPtr->GetNodeMap();
}
